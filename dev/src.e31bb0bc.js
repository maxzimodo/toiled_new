...
},{"core-js/library/fn/parse-int":"../node_modules/core-js/library/fn/parse-int.js"}],"components/player/player.js":[function(require,module,exports) {
"use strict";
...
var Player = function Player() {
  var systemPlayers = document.getElementsByClassName('system-player');
  var playBtns = document.getElementsByClassName('play-pause');
  var inputRanges = document.getElementsByClassName('range');
  var playersContainer = document.querySelector('.players'); //function for make time from seconds

  String.prototype.toMMSS = function () {
    var sec_num = (0, _parseInt2.default)(this, 10);
  ...
  function endSong(e) {
    var player = e.target;
    var button = player.parentNode.querySelector('.play-pause');
    player.currentTime = 0;
    button.classList.remove('play');
  }

  function setProgress(e) {
    var player = e.target.parentNode.querySelector('.system-player');
    player.currentTime = e.target.value / 100 * player.duration;
  }

  function setDuration(e) {
    var player = e.target;
    var dur = player.parentNode.querySelector('.duration');
  ...
  var _loop = function _loop(i) {
    ...
    playBtns[i].addEventListener('click', function (evt) {
      var playButton = evt.target;
      var systemPlayer = playButton.parentNode.querySelector('.system-player');
      var range = evt.target.parentNode.querySelector('.range');
      ...
      var isPlaying = playButton.classList.contains('play');
      isPlaying ? pauseIt() : playIt();
    });
  };

  for (var i = 0; i < systemPlayers.length; i++) {
    _loop(i);
  }
};
...
},{"@babel/runtime-corejs2/core-js/parse-int":"../node_modules/@babel/runtime-corejs2/core-js/parse-int.js"}],"components/header/header.js":[function(require,module,exports) {
"use strict";
...
},{"./components/player/player":"components/player/player.js","./components/header/header":"components/header/header.js"}],"../../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
